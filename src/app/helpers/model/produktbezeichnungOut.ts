...
export interface ProduktbezeichnungOut { 
    anbieterLabel: string;
    /**
     * anbieter / provider, like CSS or ARCOSANA
     */
    anbieter: ProduktbezeichnungOut.AnbieterEnum;
    /**
     ...
     * level
     */
    ebene: ProduktbezeichnungOut.EbeneEnum;
    /**
     * unique identifier
     */
    fachschluessel: string;
    /**
     * product name label in chosen language
     */
    produktbezeichnung: string;
}
export namespace ProduktbezeichnungOut {
