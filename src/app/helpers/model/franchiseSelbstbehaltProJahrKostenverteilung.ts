...
export interface FranchiseSelbstbehaltProJahrKostenverteilung { 
    /**
     * total not covered costs
     */
    totalNVK: number;
    /**
     * total insurance company
     */
    totalVersicherer: number;
    /**
     * total versicherte person / insured person
     */
    totalVersichertePerson: number;
}
