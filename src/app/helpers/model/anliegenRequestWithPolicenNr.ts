...
export interface AnliegenRequestWithPolicenNr { 
    /**
     ...
     */
    eingangsDokumentenKlasse?: AnliegenRequestWithPolicenNr.EingangsDokumentenKlasseEnum;
    /**
     * policen number / versicherte person policies unique identifier
     */
    policenNr: string;
}
export namespace AnliegenRequestWithPolicenNr {
